...
public class CryptoServerDb {
    private final int mPort;
    private ServerSocket mServerSocket;
    private boolean mRunning;

    public CryptoServerDb(int port) {
        this.mPort = port;
        init();
    }
    ...
    private void init() {
        ...
        Runnable runnable = () -> {
            try {
                ...
                final CryptoLogDb logger = CryptoLogDb.getInstance();
                final String servername = CryptoConst.DATABASE_NAME;
