...
public class CryptoServerMail {
    private final int mPort;
    private ServerSocket mServerSocket;
    private boolean mRunning;

    public CryptoServerMail(int port) {
        this.mPort = port;
        init();
    }
    ...
    private void init() {
        ...
        Runnable runnable = () -> {
            try {
                ...
                final CryptoLogMail logger = CryptoLogMail.getInstance();
                final String servername = CryptoConst.MAIL_NAME;
